...
const Income = () => {
    ...
    const handleAddIncome = async (income) => {
        ...
        try {
            const response = await axiosConfig.post(ENDPOINTS.ADD_INCOME, {
                name,
    ...
    const deleteIncome = async (id) => {
        try {
            await axiosConfig.delete(ENDPOINTS.DELETE_INCOME(id));
    ...
    const handleDownloadIncomeDetails = async() => {
        try {
            const response = await axiosConfig.get(ENDPOINTS.INCOME_EXCEL_DOWNLOAD, {responseType: "blob"});
    ...
    const handleEmailIncomeDetails = async () => {
        try {
            const response = await axiosConfig.get(ENDPOINTS.EMAIL_INCOME);
            if (response.status === 200) {
