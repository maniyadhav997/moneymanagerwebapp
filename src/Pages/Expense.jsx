...
const Expense = () => {
    ...
    const fetchExpenseCategories = async () => {
        try {
            const response = await axiosConfig.get(
                ENDPOINTS.CATEGORY_BY_TYPE("expense") // Fetch categories of type 'expense'
            );
            if (response.data) {
    ...
    const handleAddExpense = async (expense) => {
        ...
        try {
            await axiosConfig.post(ENDPOINTS.ADD_EXPENSE, {
                name,
    ...
    const deleteExpense = async (id) => {
        try {
            await axiosConfig.delete(ENDPOINTS.DELETE_EXPENSE(id));
    ...
    const handleDownloadExpenseDetails = async () => {
        try {
            const response = await axiosConfig.get(
                ENDPOINTS.EXPENSE_EXCEL_DOWNLOAD, // Ensure this path is correct, e.g., "/download/income"
                {
    ...
    const handleEmailExpenseDetails = async () => {
        try {
            const response = await axiosConfig.get(ENDPOINTS.EMAIL_EXPENSE);
